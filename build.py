  ...
  <section class="hero">
    <div class="wrap hero__grid">
      <div class="hero__copy">
        <span class="eyebrow">Interior Design + Home Organization</span>
      ...
      <form class="contact__form reveal" id="contactForm" novalidate>
        ...
        <div class="field"><label for="cf-type">Project type</label>
          <select id="cf-type" name="type">
            ...
            <option>Room Refresh</option><option>Room Transformation</option>
            <option>Kitchen Design</option><option>Shopping &amp; Sourcing</option><option>Not sure yet</option>
          </select>
        </div>
